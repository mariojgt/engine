...
import { NodeEditor, Scope } from "./rete.js";

//#region node_modules/rete-area-plugin/rete-area-plugin.esm.js
...
var Content = /* @__PURE__ */ function() {
	...
	return _createClass(Content, [
		...
		},
		{
			key: "reorder",
			value: function() {
				var _reorder = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(target, next) {
...
var Zoom = /* @__PURE__ */ function() {
	function Zoom(intensity) {
		...
		_defineProperty(this, "wheel", function(e) {
			...
			var delta = e.deltaY < 0 ? _this.intensity : -_this.intensity;
...
var Area = /* @__PURE__ */ function() {
	function Area(container, events, guards) {
		...
		this.setZoomHandler(new Zoom(.1));
	...
	return _createClass(Area, [
		...
		},
		{
			key: "translate",
			value: function() {
				var _translate = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(x, y) {
					var position, result;
					return import_regenerator.default.wrap(function _callee$(_context) {
						while (1) switch (_context.prev = _context.next) {
							case 0:
							...
							case 11: return _context.abrupt("return", true);
							case 12:
							case "end": return _context.stop();
						}
					}, _callee, this);
		...
		},
		{
			key: "zoom",
			value: function() {
				var _zoom2 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee2(_zoom) {
					...
					return import_regenerator.default.wrap(function _callee2$(_context2) {
						while (1) switch (_context2.prev = _context2.next) {
							...
							case 16: return _context2.abrupt("return", false);
							case 17:
...
var NodeView = /* @__PURE__ */ function() {
	function NodeView(getZoom, events, guards) {
		...
		_defineProperty(this, "translate", /* @__PURE__ */ function() {
			var _ref = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(x, y) {
				...
				return import_regenerator.default.wrap(function _callee$(_context) {
					while (1) switch (_context.prev = _context.next) {
						...
						case 10: return _context.abrupt("return", true);
						case 11:
						case "end": return _context.stop();
					}
				}, _callee);
		...
		_defineProperty(this, "resize", /* @__PURE__ */ function() {
			var _ref2 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee2(width, height) {
				var size, el;
				return import_regenerator.default.wrap(function _callee2$(_context2) {
					while (1) switch (_context2.prev = _context2.next) {
						case 0:
							...
							_context2.next = 3;
							return _this.guards.resize({ size });
						case 3:
							if (_context2.sent) {
								_context2.next = 5;
								break;
						...
						case 8:
							...
							_context2.next = 12;
							return _this.events.resized({ size });
						case 12: return _context2.abrupt("return", true);
						case 13:
						case "end": return _context2.stop();
					}
				}, _callee2);
...
function getBoundingBox(plugin, nodes) {
	...
	return getBoundingBox$1(getNodesRect(nodes.map(function(node) {
...
function restrictor(plugin, params) {
	...
	plugin.addPipe(function(context) {
		if (!context || _typeof(context) !== "object" || !("type" in context)) return context;
		if (scaling && context.type === "zoom") return _objectSpread$2(_objectSpread$2({}, context), {}, { data: _objectSpread$2(_objectSpread$2({}, context.data), {}, { zoom: restrictZoom(context.data.zoom) }) });
		...
		if (translation && context.type === "translate") return _objectSpread$2(_objectSpread$2({}, context), {}, { data: _objectSpread$2(_objectSpread$2({}, context.data), {}, { position: restrictPosition(context.data.position) }) });
		return context;
	});
}
/**
...
var Selector = /* @__PURE__ */ function() {
	...
	return _createClass(Selector, [
		...
		},
		{
			key: "add",
			value: function() {
				var _add = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(entity, accumulate) {
					return import_regenerator.default.wrap(function _callee$(_context) {
						while (1) switch (_context.prev = _context.next) {
							case 0:
								if (accumulate) {
							...
							case 3: this.entities.set("".concat(entity.label, "_").concat(entity.id), entity);
							case 4:
							case "end": return _context.stop();
						}
					}, _callee, this);
		...
		},
		{
			key: "remove",
			value: function() {
				var _remove = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee2(entity) {
					var id, item;
					return import_regenerator.default.wrap(function _callee2$(_context2) {
						while (1) switch (_context2.prev = _context2.next) {
							case 0:
		...
		},
		{
			key: "unselectAll",
			value: function() {
				var _unselectAll = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee3() {
					var _this = this;
		...
		},
		{
			key: "translate",
			value: function() {
				var _translate = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee4(dx, dy) {
					var _this2 = this;
...
function selectableNodes(base, core, options) {
	...
	*/
	function _add2() {
		_add2 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee7(nodeId, accumulate) {
			var node;
					...
					case 3:
						...
						return core.add({
							...
							translate: function translate(dx, dy) {
								return _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee6() {
									var view, current;
	...
	function _remove2() {
		_remove2 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee8(nodeId) {
	...
	area.addPipe(/* @__PURE__ */ function() {
		var _ref = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee5(context) {
			...
			return import_regenerator.default.wrap(function _callee5$(_context5) {
				while (1) switch (_context5.prev = _context5.next) {
					...
					case 32: twitch = null;
					case 33: return _context5.abrupt("return", context);
					case 34:
...
function snapGrid(base, params) {
	...
	area.addPipe(function(context) {
		...
		if (dynamic && context.type === "nodetranslate") {
			...
			return _objectSpread$1(_objectSpread$1({}, context), {}, { data: _objectSpread$1(_objectSpread$1({}, context.data), {}, { position: {
				x,
				y
			} }) });
		}
...
function _zoomAt() {
	_zoomAt = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(plugin, nodes, params) {
		var _ref, _ref$scale, scale, editor, list, rects, boundingBox, _ref2, w, h, kw, kh, k;
		return import_regenerator.default.wrap(function _callee$(_context) {
			while (1) switch (_context.prev = _context.next) {
				case 0:
					_ref = params || {}, _ref$scale = _ref.scale, scale = _ref$scale === void 0 ? .9 : _ref$scale;
	...
	return _createClass(AreaPlugin, [
		...
		},
		{
			...
			value: function addConnectionView(connection) {
				var _this3 = this;
				var view = new ConnectionView({ contextmenu: function contextmenu(event) {
					_this3.emit({
						type: "contextmenu",
						data: {
							event,
		...
		},
		{
			key: "update",
			value: function() {
				var _update = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(type, id) {
					var data;
					return import_regenerator.default.wrap(function _callee$(_context) {
						while (1) switch (_context.prev = _context.next) {
							case 0:
		...
		},
		{
			key: "resize",
			value: function() {
				var _resize = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee2(id, width, height) {
					var view;
					return import_regenerator.default.wrap(function _callee2$(_context2) {
						while (1) switch (_context2.prev = _context2.next) {
							case 0:
							...
							case 4: return _context2.abrupt("return", _context2.sent);
							case 5:
							case "end": return _context2.stop();
						}
					}, _callee2, this);
		...
		},
		{
			key: "translate",
			value: function() {
				var _translate = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee3(id, _ref3) {
					var x, y, view;
					return import_regenerator.default.wrap(function _callee3$(_context3) {
						while (1) switch (_context3.prev = _context3.next) {
							case 0:
							...
							case 5: return _context3.abrupt("return", _context3.sent);
							case 6:
							case "end": return _context3.stop();
						}
					}, _callee3, this);
...
//# sourceMappingURL=rete-area-plugin.js.map