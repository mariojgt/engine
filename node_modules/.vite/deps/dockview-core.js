//#region node_modules/dockview-core/dist/esm/dnd/dataTransfer.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/events.js
var Event;
(function(Event) {
	Event.any = (...children) => {
		return (listener) => {
...
var Stacktrace = class Stacktrace {
	static create() {
		var _a;
		return new Stacktrace((_a = (/* @__PURE__ */ new Error()).stack) !== null && _a !== void 0 ? _a : "");
	}
	constructor(value) {
		this.value = value;
	}
...
var Emitter = class Emitter {
	...
	get event() {
		if (!this._event) {
			this._event = (callback) => {
				var _a;
				if (((_a = this.options) === null || _a === void 0 ? void 0 : _a.replay) && this._last !== void 0) callback(this._last);
	...
	fire(e) {
		var _a;
		if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.replay) this._last = e;
		for (const listener of this._listeners) listener.callback(e);
	}
	dispose() {
		if (!this._disposed) {
			this._disposed = true;
			if (this._listeners.length > 0) {
				if (Emitter.ENABLE_TRACKING) queueMicrotask(() => {
					var _a;
					for (const listener of this._listeners) console.warn("dockview: stacktrace", (_a = listener.stacktrace) === null || _a === void 0 ? void 0 : _a.print());
				});
				this._listeners = [];
			}
...
//#endregion
//#region node_modules/dockview-core/dist/esm/lifecycle.js
var Disposable;
(function(Disposable) {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dom.js
var OverflowObserver = class extends CompositeDisposable {
	constructor(el) {
		...
		this.addDisposables(this._onDidChange, watchElementResize(el, (entry) => {
			this._value = {
				hasScrollX: entry.target.scrollWidth > entry.target.clientWidth,
				hasScrollY: entry.target.scrollHeight > entry.target.clientHeight
			};
...
function disableIframePointEvents(rootNode = document) {
	...
	return { release: () => {
		var _a;
		for (const iframe of iframes) iframe.style.pointerEvents = (_a = original.get(iframe)) !== null && _a !== void 0 ? _a : "auto";
...
//#endregion
//#region node_modules/dockview-core/dist/esm/array.js
function tail(arr) {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/math.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/splitview/viewItem.js
var ViewItem = class {
	set size(size) {
		this._size = size;
	}
...
//#endregion
//#region node_modules/dockview-core/dist/esm/splitview/splitview.js
var Orientation;
...
var Splitview = class {
		...
		if (this.viewItems.length > 1) {
			...
			const onPointerStart = (event) => {
				...
				const onPointerMove = (event) => {
					const delta = (this._orientation === Orientation.HORIZONTAL ? event.clientX : event.clientY) - start;
	...
	removeView(index, sizing, skipLayout = false) {
		...
		if (sizing && sizing.type === "distribute") this.distributeViewSizes();
	...
	*/
	...
	updateSashEnablement() {
		...
		for (let index = 0; index < this.sashes.length; index++) {
			...
			if (min && max) {
				...
				if (snappedBefore && collapsesUp[index] && (position > 0 || this.startSnappingEnabled)) this.updateSash(sash, SashState.MINIMUM);
				else if (snappedAfter && collapsesDown[index] && (position < this._contentSize || this.endSnappingEnabled)) this.updateSash(sash, SashState.MAXIMUM);
				else this.updateSash(sash, SashState.DISABLED);
			} else if (min && !max) this.updateSash(sash, SashState.MINIMUM);
			else if (!min && max) this.updateSash(sash, SashState.MAXIMUM);
			else this.updateSash(sash, SashState.ENABLED);
		}
	}
	...
	createContainer() {
		const element = document.createElement("div");
		element.className = `dv-split-view-container ${this._orientation === Orientation.HORIZONTAL ? "dv-horizontal" : "dv-vertical"}`;
		return element;
	}
	dispose() {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/splitview/options.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/paneview/paneview.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/leafNode.js
var LeafNode = class {
	get minimumWidth() {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/branchNode.js
var BranchNode = class BranchNode extends CompositeDisposable {
	...
	get priority() {
		...
		if (priorities.some((p) => p === LayoutPriority.High)) return LayoutPriority.High;
		else if (priorities.some((p) => p === LayoutPriority.Low)) return LayoutPriority.Low;
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/gridview.js
...
var Gridview = class {
	...
	maximizeView(view) {
		...
		if (((_a = this._maximizedNode) === null || _a === void 0 ? void 0 : _a.leaf) === node) return;
 ...
 /**
		...
		*/
		...
		if (maxmizedViewLocation) resullt.maximizedNode = { location: maxmizedViewLocation };
	...
	_deserializeNode(node, orientation, deserializer, orthogonalSize) {
		...
		if (node.type === "branch") {
			...
			if (typeof node.visible === "boolean") (_a = view.setVisible) === null || _a === void 0 || _a.call(view, node.visible);
	...
	*/
	...
	progmaticSelect(location, reverse = false) {
		...
		if (!(node instanceof LeafNode)) throw new Error("invalid location");
	...
	isViewVisible(location) {
		...
		if (!(parent instanceof BranchNode)) throw new Error("Invalid from location");
	...
	moveView(parentLocation, from, to) {
		...
		if (!(parent instanceof BranchNode)) throw new Error("Invalid location");
	...
	getNode(location, node = this.root, path = []) {
		...
		if (!(node instanceof BranchNode)) throw new Error("Invalid location");
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/options.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/resizable.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/baseComponentGridview.js
...
var BaseGrid = class extends Resizable {
	...
	constructor(container, options) {
		...
		this.addDisposables(this.gridview.onDidMaximizedNodeChange((event) => {
			...
			var _a;
			(_a = this.element.parentElement) === null || _a === void 0 || _a.removeChild(this.element);
	...
	updateOptions(options) {
		...
		if ("disableResizing" in options) this.disableResizing = (_a = options.disableAutoResizing) !== null && _a !== void 0 ? _a : false;
		if ("locked" in options) this.locked = (_b = options.locked) !== null && _b !== void 0 ? _b : false;
		if ("margin" in options) this.gridview.margin = (_c = options.margin) !== null && _c !== void 0 ? _c : 0;
		if ("className" in options) this._classNames.setClassNames((_d = options.className) !== null && _d !== void 0 ? _d : "");
	}
	maximizeGroup(panel) {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/component.api.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dnd/abstractDragHandler.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dnd/dnd.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dnd/droptarget.js
function setGPUOptimizedBounds(element, bounds) {
	...
	if (!element.style.transform || element.style.transform === "") element.style.transform = "translate3d(0, 0, 0)";
}
...
var Droptarget = class Droptarget extends CompositeDisposable {
	...
	constructor(element, options) {
		...
		this.dnd = new DragAndDropObserver(this.element, {
			onDragEnter: () => {
				var _a, _b, _c;
				(_c = (_b = (_a = this.options).getOverrideTarget) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 || _c.getElements();
			},
			onDragOver: (e) => {
			...
			onDragLeave: () => {
				var _a, _b;
				if ((_b = (_a = this.options).getOverrideTarget) === null || _b === void 0 ? void 0 : _b.call(_a)) return;
				this.removeDropTarget();
			},
			onDragEnd: (e) => {
				var _a, _b;
			...
			onDrop: (e) => {
				...
				this.removeDropTarget();
				(_c = (_b = (_a = this.options).getOverrideTarget) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 || _c.clear();
				if (state) {
					e.stopPropagation();
					this._onDrop.fire({
						position: state,
	...
	*/
	...
	toggleClasses(quadrant, width, height) {
		var _a, _b, _c, _d, _e, _f, _g;
		const target = (_b = (_a = this.options).getOverrideTarget) === null || _b === void 0 ? void 0 : _b.call(_a);
		if (!target && !this.overlayElement) return;
		...
		if (target) {
			...
			} else if (leftClass) box.width = width * size;
			else if (topClass) box.height = height * size;
			else if (bottomClass) {
				box.top = rootTop + height * (1 - size);
				box.height = height * size;
			}
			if (isSmallX && isLeft) box.width = 4;
			if (isSmallX && isRight) {
				box.left = rootLeft + width - 4;
				box.width = 4;
			}
			if (!checkBoundsChanged(overlay, box)) return;
	...
	removeDropTarget() {
		...
		if (this.targetElement) {
			this._state = void 0;
			(_a = this.targetElement.parentElement) === null || _a === void 0 || _a.classList.remove("dv-drop-target");
...
//#endregion
//#region node_modules/dockview-core/dist/esm/paneview/options.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/panelApi.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/splitviewPanelApi.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/paneviewPanelApi.js
var PaneviewPanelApiImpl = class extends SplitviewPanelApiImpl {
	...
	setExpanded(isExpanded) {
		var _a;
		(_a = this._pane) === null || _a === void 0 || _a.setExpanded(isExpanded);
	}
	get isExpanded() {
		var _a;
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/basePanelView.js
var BasePanelView = class extends CompositeDisposable {
	...
	update(event) {
		...
		*/
		...
		(_b = this.part) === null || _b === void 0 || _b.update({ params: this._params.params });
	}
	toJSON() {
		var _a, _b;
	...
	dispose() {
		var _a;
		this.api.dispose();
		(_a = this.part) === null || _a === void 0 || _a.dispose();
		super.dispose();
	}
};

//#endregion
//#region node_modules/dockview-core/dist/esm/paneview/paneviewPanel.js
var PaneviewPanel = class extends BasePanelView {
	...
	setExpanded(expanded) {
		...
		} else this.animationTimer = setTimeout(() => {
			var _a;
			(_a = this.body) === null || _a === void 0 || _a.remove();
		}, 200);
	...
	init(parameters) {
		...
		(_a = this.body) === null || _a === void 0 || _a.append(this.bodyPart.element);
		(_b = this.header) === null || _b === void 0 || _b.append(this.headerPart.element);
	...
	getComponent() {
		return {
			update: (params) => {
				var _a, _b;
				(_a = this.bodyPart) === null || _a === void 0 || _a.update({ params });
				(_b = this.headerPart) === null || _b === void 0 || _b.update({ params });
			},
			dispose: () => {
				var _a, _b;
				(_a = this.bodyPart) === null || _a === void 0 || _a.dispose();
				(_b = this.headerPart) === null || _b === void 0 || _b.dispose();
			}
		};
	}
};
...
//#endregion
//#region node_modules/dockview-core/dist/esm/paneview/draggablePaneviewPanel.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/panel/content.js
var ContentContainer = class extends CompositeDisposable {
	...
	constructor(accessor, group) {
		...
		this.dropTarget = new Droptarget(this.element, {
			...
			canDisplayOverlay: (event, position) => {
				if (this.group.locked === "no-drop-target" || this.group.locked && position === "center") return false;
				const data = getPanelData();
				if (!data && event.shiftKey && this.group.location.type !== "floating") return false;
				if (data && data.viewId === this.accessor.id) return true;
 ...
 /**
		...
		*/
		...
		switch (panel.api.renderer) {
			case "onlyWhenVisible":
				...
				if (this.panel) {
					if (doRender) this._element.appendChild(this.panel.view.content.element);
				}
				container = this._element;
				break;
			case "always":
				if (panel.view.content.element.parentElement === this._element) this._element.removeChild(panel.view.content.element);
	...
	closePanel() {
		var _a;
		if (this.panel) {
			if (this.panel.api.renderer === "onlyWhenVisible") (_a = this.panel.view.content.element.parentElement) === null || _a === void 0 || _a.removeChild(this.panel.view.content.element);
		}
		this.panel = void 0;
	}
	dispose() {
	...
	*/
	refreshFocusState() {
		var _a;
		if ((_a = this.focusTracker) === null || _a === void 0 ? void 0 : _a.refreshState) this.focusTracker.refreshState();
	}
};

//#endregion
//#region node_modules/dockview-core/dist/esm/dnd/ghost.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/tab/tab.js
...
var Tab = class extends CompositeDisposable {
	...
	constructor(panel, accessor, group) {
		...
		this.dropTarget = new Droptarget(this._element, {
			...
			canDisplayOverlay: (event, position) => {
				...
				const data = getPanelData();
				if (data && this.accessor.id === data.viewId) return true;
	...
	setContent(part) {
		if (this.content) this._element.removeChild(this.content.element);
		this.content = part;
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/events.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dnd/groupDragHandler.js
var GroupDragHandler = class extends DragHandler {
 ...
 /**
	...
	isCancelled(_event) {
		if (this.group.api.location.type === "floating" && !_event.shiftKey) return true;
		return false;
	}
	getData(dragEvent) {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/titlebar/voidContainer.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/scrollbar.js
	...
	constructor(scrollableElement) {
		...
		this.addDisposables(addDisposableListener(this.element, "wheel", (event) => {
			...
			const onPointerMove = (event) => {
				...
				this._scrollLeft = originalScrollLeft + deltaX / (clientWidth / scrollWidth);
				this.calculateScrollbarStyles();
			};
			const onEnd = () => {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/titlebar/tabs.js
var Tabs = class extends CompositeDisposable {
	...
	setActivePanel(panel) {
		...
		for (const tab of this._tabs) {
			...
			if (isActivePanel) {
				...
				const parentElement = element.parentElement;
				if (runningWidth < parentElement.scrollLeft || runningWidth + element.clientWidth > parentElement.scrollLeft + parentElement.clientWidth) parentElement.scrollLeft = runningWidth;
			}
			runningWidth += tab.value.element.clientWidth;
		}
	}
	openPanel(panel, index = this._tabs.length) {
		if (this._tabs.find((tab) => tab.value.panel.id === panel.id)) return;
		...
		const value = {
			...
			disposable: new CompositeDisposable(tab.onDragStart((event) => {
				...
				switch (event.button) {
					case 0:
						if (this.group.activePanel !== panel) this.group.model.openPanel(panel);
						break;
				}
			}), tab.onDrop((event) => {
				this._onDrop.fire({
	...
	delete(id) {
		...
		const { value, disposable } = this._tabs.splice(index, 1)[0];
		disposable.dispose();
		value.dispose();
...
//#endregion
//#region node_modules/dockview-core/dist/esm/svg.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/titlebar/tabOverflowControl.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/titlebar/tabsContainer.js
var TabsContainer = class extends CompositeDisposable {
	...
	constructor(accessor, group) {
		...
		this.addDisposables(this.tabs.onDrop((e) => this._onDrop.fire(e)), this.tabs.onWillShowOverlay((e) => this._onWillShowOverlay.fire(e)), accessor.onDidOptionsChange(() => {
			...
			if (event.defaultPrevented) return;
			if (!this.accessor.options.disableFloatingGroups && event.shiftKey && this.group.api.location.type !== "floating") {
				event.preventDefault();
	...
	toggleDropdown(options) {
		...
		this._dropdownDisposable.value = new CompositeDisposable(Disposable.from(() => {
			var _a, _b;
			root.remove();
			(_b = (_a = this.dropdownPart) === null || _a === void 0 ? void 0 : _a.dispose) === null || _b === void 0 || _b.call(_a);
			this.dropdownPart = null;
			...
			for (const tab of this.tabs.tabs.filter((tab) => this._overflowTabs.includes(tab.panel.id))) {
				...
				const child = panelObject.view.createTabRenderer("headerOverflow").element;
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/options.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/dockviewGroupPanelModel.js
...
var DockviewGroupPanelModel = class extends CompositeDisposable {
	...
	set location(value) {
		...
		switch (value.type) {
			...
			case "floating":
				...
				this.contentContainer.dropTarget.setTargetZones(value ? ["center"] : [
					"top",
					"bottom",
					"left",
					"right",
	...
	moveToNext(options) {
		if (!options) options = {};
		if (!options.panel) options.panel = this.activePanel;
		const index = options.panel ? this.panels.indexOf(options.panel) : -1;
		let normalizedIndex;
		if (index < this.panels.length - 1) normalizedIndex = index + 1;
		else if (!options.suppressRoll) normalizedIndex = 0;
		else return;
	...
	moveToPrevious(options) {
		...
		else if (!options.suppressRoll) normalizedIndex = this.panels.length - 1;
		else return;
		this.openPanel(this.panels[normalizedIndex]);
	}
	containsPanel(panel) {
	...
	focus() {
		var _a;
		(_a = this._activePanel) === null || _a === void 0 || _a.focus();
	}
	...
	removePanel(groupItemOrId, options = { skipSetActive: false }) {
	...
	setActive(isGroupActive, force = false) {
		...
		if (!this._activePanel && this.panels.length > 0) this.doSetActivePanel(this.panels[0]);
		this.updateContainer();
	}
	layout(width, height) {
		var _a;
		...
		if ((_a = this._activePanel) === null || _a === void 0 ? void 0 : _a.layout) this._activePanel.layout(this._width, this._height);
	}
	...
	doAddPanel(panel, index = this.panels.length, options = { skipSetActive: false }) {
		...
		if (!options.skipSetActive) this.contentContainer.openPanel(panel);
	...
	updateContainer() {
		...
		if (!this.isEmpty && this.watermark) {
			...
			(_b = (_a = this.watermark).dispose) === null || _b === void 0 || _b.call(_a);
	...
	dispose() {
		var _a, _b, _c;
		super.dispose();
		(_a = this.watermark) === null || _a === void 0 || _a.element.remove();
		(_c = (_b = this.watermark) === null || _b === void 0 ? void 0 : _b.dispose) === null || _c === void 0 || _c.call(_b);
		this.watermark = void 0;
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/gridviewPanelApi.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/gridviewPanel.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/dockviewGroupPanelApi.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/dockviewGroupPanel.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/theme.js
const themeDark = {
	name: "dark",
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/dockviewPanelApi.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/dockviewPanel.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/tab/defaultTab.js
var DefaultTab = class extends CompositeDisposable {
	...
	render() {
		var _a;
		if (this._content.textContent !== this._title) this._content.textContent = (_a = this._title) !== null && _a !== void 0 ? _a : "";
	}
};

//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/dockviewPanelModel.js
var DockviewPanelModel = class {
	...
	createTabRenderer(tabLocation) {
		...
		if (this._params) cmp.init(Object.assign(Object.assign({}, this._params), { tabLocation }));
		if (this._updateEvent) (_a = cmp.update) === null || _a === void 0 || _a.call(cmp, this._updateEvent);
		return cmp;
	}
	init(params) {
		this._params = params;
	...
	layout(width, height) {
		var _a, _b;
		(_b = (_a = this.content).layout) === null || _b === void 0 || _b.call(_a, width, height);
	}
	update(event) {
		var _a, _b, _c, _d;
		this._updateEvent = event;
		(_b = (_a = this.content).update) === null || _b === void 0 || _b.call(_a, event);
		(_d = (_c = this.tab).update) === null || _d === void 0 || _d.call(_c, event);
	}
	dispose() {
		var _a, _b, _c, _d;
		(_b = (_a = this.content).dispose) === null || _b === void 0 || _b.call(_a);
		(_d = (_c = this.tab).dispose) === null || _d === void 0 || _d.call(_c);
	}
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/deserializer.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/watermark/watermark.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/overlay/overlay.js
...
var Overlay = class Overlay extends CompositeDisposable {
	...
	toJSON() {
		...
		const result = {};
		if (this.verticalAlignment === "top") result.top = parseFloat(this._element.style.top);
		else if (this.verticalAlignment === "bottom") result.bottom = parseFloat(this._element.style.bottom);
		else result.top = element.top - container.top;
		if (this.horiziontalAlignment === "left") result.left = parseFloat(this._element.style.left);
		else if (this.horiziontalAlignment === "right") result.right = parseFloat(this._element.style.right);
	...
	setupDrag(dragTarget, options = { inDragMode: false }) {
		...
		const track = () => {
			let offset = null;
			const iframes = disableIframePointEvents();
			move.value = new CompositeDisposable({ dispose: () => {
				iframes.release();
		...
		this.addDisposables(move, addDisposableListener(dragTarget, "pointerdown", (event) => {
			...
			if (event.defaultPrevented) return;
			if (quasiDefaultPrevented(event)) return;
			if (event.shiftKey) track();
		}), addDisposableListener(this.options.content, "pointerdown", () => {
			arialLevelTracker.push(this._element);
		}, true));
		if (options.inDragMode) track();
	}
	setupResize(direction) {
		...
		this.addDisposables(move, addDisposableListener(resizeHandleElement, "pointerdown", (e) => {
			...
			move.value = new CompositeDisposable(addDisposableListener(window, "pointermove", (e) => {
				...
				let width = void 0;
				const moveTop = () => {
					top = clamp(y, 0, startPosition.originalY + startPosition.originalHeight > containerRect.height ? Math.max(0, containerRect.height - Overlay.MINIMUM_HEIGHT) : Math.max(0, startPosition.originalY + startPosition.originalHeight - Overlay.MINIMUM_HEIGHT));
				...
				const moveLeft = () => {
					left = clamp(x, 0, startPosition.originalX + startPosition.originalWidth > containerRect.width ? Math.max(0, containerRect.width - Overlay.MINIMUM_WIDTH) : Math.max(0, startPosition.originalX + startPosition.originalWidth - Overlay.MINIMUM_WIDTH));
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/dockviewFloatingGroupPanel.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/constants.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/overlay/overlayRenderContainer.js
var PositionCache = class {
	...
	getPosition(element) {
		...
		if (cached && cached.frameId === this.currentFrameId) return cached.rect;
...
var OverlayRenderContainer = class extends CompositeDisposable {
	...
	attach(options) {
		...
		if (panel.view.content.element.parentElement !== focusContainer) focusContainer.appendChild(panel.view.content.element);
		...
		const resize = () => {
			...
			requestAnimationFrame(() => {
				...
				if (this.isDisposed || !this.map[panelId]) return;
		...
		this.map[panel.api.id].destroy = Disposable.from(() => {
			var _a;
			if (panel.view.content.element.parentElement === focusContainer) focusContainer.removeChild(panel.view.content.element);
			(_a = focusContainer.parentElement) === null || _a === void 0 || _a.removeChild(focusContainer);
		});
		correctLayerPosition();
		queueMicrotask(() => {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/popoutWindow.js
...
var PopoutWindow = class extends CompositeDisposable {
	...
	close() {
		...
		if (this._window) {
			...
			(_b = (_a = this.options).onWillClose) === null || _b === void 0 || _b.call(_a, {
				id: this.target,
	...
	open() {
		...
		return __awaiter(this, void 0, void 0, function* () {
			if (this._window) throw new Error("instance of popout window is already open");
 ...
 /**
			...
			*/
			...
			if (this.className) container.classList.add(this.className);
			(_b = (_a = this.options).onDidOpen) === null || _b === void 0 || _b.call(_a, {
				id: this.target,
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/strictEventsSequencing.js
var StrictEventsSequencing = class extends CompositeDisposable {
	...
	init() {
		...
		this.addDisposables(this.accessor.onDidAddPanel((panel) => {
			...
			if (!panels.has(panel.api.id)) throw new Error(`dockview: Invalid event sequence. [onDidRemovePanel] called for panel ${panel.api.id} but panel does not exists`);
			else panels.delete(panel.api.id);
			...
			if (!groups.has(group.api.id)) throw new Error(`dockview: Invalid event sequence. [onDidRemoveGroup] called for group ${group.api.id} but group does not exists`);
			else groups.delete(group.api.id);
		}));
	}
};

//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/components/popupService.js
var PopupService = class extends CompositeDisposable {
	...
	openPopover(element, position) {
		...
		this._activeDisposable.value = new CompositeDisposable(addDisposableListener(window, "pointerdown", (event) => {
			...
			let el = target;
			while (el && el !== wrapper) el = (_a = el === null || el === void 0 ? void 0 : el.parentElement) !== null && _a !== void 0 ? _a : null;
			if (el) return;
			this.close();
		}));
		requestAnimationFrame(() => {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dnd/dropTargetAnchorContainer.js
var DropTargetAnchorContainer = class extends CompositeDisposable {
	...
	set disabled(value) {
		...
		this._disabled = value;
		if (value) (_a = this.model) === null || _a === void 0 || _a.clear();
	}
	get model() {
		...
		return {
			clear: () => {
				var _a;
				if (this._model) (_a = this._model.root.parentElement) === null || _a === void 0 || _a.removeChild(this._model.root);
				this._model = void 0;
			},
			exists: () => {
				return !!this._model;
	...
	constructor(element, options) {
		...
		this.addDisposables(Disposable.from(() => {
			var _a;
			(_a = this.model) === null || _a === void 0 || _a.clear();
		}));
	}
	createContainer() {
		const el = document.createElement("div");
...
//#endregion
//#region node_modules/dockview-core/dist/esm/dockview/dockviewComponent.js
	...
	constructor(container, options) {
		...
		this._rootDropTarget = new Droptarget(this.element, {
			...
			canDisplayOverlay: (event, position) => {
				const data = getPanelData();
				if (data) {
					if (data.viewId !== this.id) return false;
					if (position === "center") return this.gridview.length === 0;
					return true;
				}
 ...
 /**
		...
		this.addDisposables(this.rootDropTargetContainer, this.overlayRenderContainer, this._onWillDragPanel, this._onWillDragGroup, this._onWillShowOverlay, this._onDidActivePanelChange, this._onDidAddPanel, this._onDidRemovePanel, this._onDidLayoutFromJSON, this._onDidDrop, this._onWillDrop, this._onDidMovePanel, this._onDidMovePanel.event(() => {
			...
			*/
			...
			for (const group of [...this._floatingGroups]) group.dispose();
			for (const group of [...this._popoutGroups]) group.disposable.dispose();
			...
			if (willDropEvent.defaultPrevented) return;
			const data = getPanelData();
			if (data) this.moveGroupOrPanel({
				from: {
					groupId: data.groupId,
					panelId: (_a = data.panelId) !== null && _a !== void 0 ? _a : void 0
				},
				to: {
	...
	addPopoutGroup(itemToPopout, options) {
		...
		function getBox() {
			...
			if (itemToPopout instanceof DockviewGroupPanel) return itemToPopout.element.getBoundingClientRect();
			if (itemToPopout.group) return itemToPopout.group.element.getBoundingClientRect();
		...
		return _window.open().then((popoutContainer) => {
			...
			*/
			...
			let group;
			if (!isGroupAddedToDom) group = referenceGroup;
			...
			let floatingBox;
			if (!(options === null || options === void 0 ? void 0 : options.overridePopoutGroup) && isGroupAddedToDom) if (itemToPopout instanceof DockviewPanel) this.movingLock(() => {
			...
			popoutWindowDisposable.addDisposables(group.api.onDidActiveChange((event) => {
				var _a;
				if (event.isActive) (_a = _window.window) === null || _a === void 0 || _a.focus();
			}), group.api.onWillFocus(() => {
				var _a;
				(_a = _window.window) === null || _a === void 0 || _a.focus();
			}));
			let returnedGroup;
				...
				*/
				...
				Disposable.from(() => {
					...
					if (isGroupAddedToDom && this.getPanel(referenceGroup.id)) {
						...
						returnedGroup = group;
						if (!this._popoutGroups.find((p) => p.popoutGroup === group))
 /**
						...
						*/
						return;
						if (floatingBox) this.addFloatingGroup(group, {
	...
	addFloatingGroup(item, options) {
		...
		if (!el) throw new Error("dockview: failed to find drag handle");
		overlay.setupDrag(el, { inDragMode: typeof (options === null || options === void 0 ? void 0 : options.inDragMode) === "boolean" ? options.inDragMode : false });
		...
		if (!(options === null || options === void 0 ? void 0 : options.skipActiveGroup)) this.doSetGroupAndPanelActive(group);
		this.updateWatermark();
	}
	orthogonalize(position, options) {
		...
		switch (position) {
			case "top":
			case "bottom":
				if (this.gridview.orientation === Orientation.HORIZONTAL) this.gridview.insertOrthogonalSplitviewAtRoot();
				break;
			case "left":
			case "right":
				if (this.gridview.orientation === Orientation.VERTICAL) this.gridview.insertOrthogonalSplitviewAtRoot();
				break;
			default: break;
		}
		switch (position) {
	...
	updateOptions(options) {
		...
		if ("floatingGroupBounds" in options) for (const group of this._floatingGroups) {
		...
		if (oldDisableDnd !== this.options.disableDnd) this.updateDragAndDropState();
		if ("theme" in options) this.updateTheme();
		this.layout(this.gridview.width, this.gridview.height, true);
	}
	layout(width, height, forceResize) {
		super.layout(width, height, forceResize);
		if (this._floatingGroups) for (const floating of this._floatingGroups) floating.overlay.setBounds();
	}
	updateDragAndDropState() {
	...
	focus() {
		var _a;
		(_a = this.activeGroup) === null || _a === void 0 || _a.focus();
	}
	getGroupPanel(id) {
	...
	*/
	...
	fromJSON(data, options) {
		...
		if (grid.root.type !== "branch" || !Array.isArray(grid.root.data)) throw new Error("dockview: root must be of type branch");
		try {
			const width = this.width;
			const height = this.height;
			const createGroupFromSerializedState = (data) => {
				const { id, locked, hideHeader, views, activeView } = data;
				if (typeof id !== "string") throw new Error("dockview: group id must be of type string");
			...
			for (const floatingGroup of this._floatingGroups) floatingGroup.overlay.setBounds();
			...
			*/
			...
			for (const floatingGroup of [...this._floatingGroups]) floatingGroup.dispose();
			this.clear();
			/**
	...
	clear() {
		...
		for (const group of groups) this.removeGroup(group, { skipActive: true });
	...
	addPanel(options) {
		var _a, _b;
		if (this.panels.find((_) => _.id === options.id)) throw new Error(`dockview: panel with id ${options.id} already exists`);
		let referenceGroup;
		...
		if (options.position) if (isPanelOptionsWithPanel(options.position)) {
			...
			if (!referencePanel) throw new Error(`dockview: referencePanel '${options.position.referencePanel}' does not exist`);
			...
			index = options.position.index;
			if (!referenceGroup) throw new Error(`dockview: referenceGroup '${options.position.referenceGroup}' does not exist`);
		} else {
	...
	updateWatermark() {
		...
		if (this.groups.filter((x) => x.api.location.type === "grid" && x.api.isVisible).length === 0) {
			if (!this._watermark) {
				...
				this._watermark.init({ containerApi: new DockviewApi(this) });
			...
			(_b = (_a = this._watermark).dispose) === null || _b === void 0 || _b.call(_a);
			this._watermark = null;
		}
	}
	addGroup(options) {
		...
		if (options) {
			...
			if (isGroupOptionsWithPanel(options)) {
				...
				if (!referencePanel) throw new Error(`dockview: reference panel ${options.referencePanel} does not exist`);
				referenceGroup = this.findGroup(referencePanel);
				if (!referenceGroup) throw new Error(`dockview: reference group for reference panel ${options.referencePanel} does not exist`);
				...
				if (!referenceGroup) throw new Error(`dockview: reference group ${options.referenceGroup} does not exist`);
			} else {
	...
	doRemoveGroup(group, options) {
		...
		if (!(options === null || options === void 0 ? void 0 : options.skipDispose)) for (const panel of panels) this.removePanel(panel, {
			removeEmptyGroup: false,
			...
			if (selectedGroup) {
				if (!(options === null || options === void 0 ? void 0 : options.skipDispose)) {
					if (!(options === null || options === void 0 ? void 0 : options.skipPopoutAssociated)) {
						...
						if (refGroup && refGroup.panels.length === 0) this.removeGroup(refGroup);
					}
		...
		if (!(options === null || options === void 0 ? void 0 : options.skipActive)) {
			if (this.activePanel !== activePanel) this._onDidActivePanelChange.fire(this.activePanel);
		}
		return re;
	}
		...
		if (target === "center") {
			...
			switch (from.api.location.type) {
				...
				case "popout": {
					...
					if (index >= 0) this._popoutGroups.splice(index, 1);
			...
			if (to.api.location.type === "grid") {
				...
				if (targetFloatingGroup) {
					...
					let left, top;
					if ("left" in box) left = box.left + 50;
					else if ("right" in box) left = Math.max(0, box.right - box.width - 50);
					else left = 50;
					if ("top" in box) top = box.top + 50;
					else if ("bottom" in box) top = Math.max(0, box.bottom - box.height - 50);
					else top = 50;
	...
	doSetGroupActive(group) {
		...
		const activePanel = this.activePanel;
		if (!this._moving && activePanel !== this._onDidActivePanelChange.value) this._onDidActivePanelChange.fire(activePanel);
	}
	...
	createGroup(options) {
		...
		if (!this._groups.has(view.id)) {
			const disposable = new CompositeDisposable(view.model.onTabDragStart((event) => {
				...
				if (this._onDidActivePanelChange.value !== event.panel) this._onDidActivePanelChange.fire(event.panel);
	...
	updateDropTargetModel(options) {
		if ("dndEdges" in options) {
			...
			if (typeof options.dndEdges === "object" && options.dndEdges !== null) this._rootDropTarget.setOverlayModel(options.dndEdges);
			else this._rootDropTarget.setOverlayModel(DEFAULT_ROOT_OVERLAY_MODEL);
		}
		if ("rootOverlayModel" in options) this.updateDropTargetModel({ dndEdges: options.dndEdges });
	}
	updateTheme() {
		var _a, _b;
...
//#endregion
//#region node_modules/dockview-core/dist/esm/gridview/gridviewComponent.js
	...
	registerPanel(panel) {
		const disposable = new CompositeDisposable(panel.api.onDidFocusChange((event) => {
			...
			this._groups.forEach((groupItem) => {
				...
				if (group !== panel) group.setActive(false);
...
//#endregion
//#region node_modules/dockview-core/dist/esm/splitview/splitviewComponent.js
/**
...
var SplitviewComponent = class extends Resizable {
	...
	updateOptions(options) {
		var _a, _b;
		if ("className" in options) this._classNames.setClassNames((_a = options.className) !== null && _a !== void 0 ? _a : "");
		if ("disableResizing" in options) this.disableResizing = (_b = options.disableAutoResizing) !== null && _b !== void 0 ? _b : false;
...
//#endregion
//#region node_modules/dockview-core/dist/esm/paneview/defaultPaneviewHeader.js
var DefaultHeader = class extends CompositeDisposable {
	...
	constructor() {
		...
		this.addDisposables(addDisposableListener(this._element, "click", () => {
			var _a;
			(_a = this.apiRef.api) === null || _a === void 0 || _a.setExpanded(!this.apiRef.api.isExpanded);
		}));
	}
	init(params) {
...
//#endregion
//#region node_modules/dockview-core/dist/esm/paneview/paneviewComponent.js
...
var PaneviewComponent = class extends Resizable {
	...
	constructor(container, options) {
		...
		container.appendChild(this.element);
		this._options = options;
		this.paneview = new Paneview(this.element, { orientation: Orientation.VERTICAL });
	...
	addPanel(options) {
		...
		if (!header) header = new DefaultHeader();
	...
	toJSON() {
		...
		return {
			views: this.paneview.getPanes().map((view, i) => {
				return {
					size: this.paneview.getViewSize(i),
					data: view.toJSON(),
...
//#endregion
//#region node_modules/dockview-core/dist/esm/splitview/splitviewPanel.js
...
//#endregion
//#region node_modules/dockview-core/dist/esm/api/entryPoints.js
