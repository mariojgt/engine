...
import { NodeEditor, Scope, getUID } from "./rete.js";
...
//#region node_modules/rete-connection-plugin/rete-connection-plugin.esm.js
...
function createPseudoconnection(extra) {
	...
	return {
		...
		render: function render(areaPlugin, _ref, data) {
			...
			if (!element) element = areaPlugin.addConnectionView(payload).element;
			if (!element) return;
			areaPlugin.emit({
				type: "render",
				data: _objectSpread({
...
function elementsFromPoint(x, y) {
	...
	if (shadowRoot && shadowRoot !== root) elements.unshift.apply(elements, _toConsumableArray(elementsFromPoint(x, y, shadowRoot)));
	return elements;
}
...
function getSourceTarget(initial, socket) {
	...
	var _ref2 = _slicedToArray(forward ? [initial, socket] : backward ? [socket, initial] : [], 2), source = _ref2[0], target = _ref2[1];
...
function makeConnection(initial, socket, context) {
	var _ref4 = _slicedToArray(getSourceTarget(initial, socket) || [null, null], 2), source = _ref4[0], target = _ref4[1];
	if (source && target) {
...
var Picked$1 = /* @__PURE__ */ function(_State) {
	...
	return _createClass(Picked, [{
		key: "pick",
		value: function() {
			var _pick = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(_ref, context) {
				var socket;
...
var Idle$1 = /* @__PURE__ */ function(_State2) {
	...
	return _createClass(Idle, [{
		key: "pick",
		value: function() {
			var _pick2 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee2(_ref2, context) {
				var socket, event;
	...
	return _createClass(BidirectFlow, [
		{
			key: "pick",
			value: function() {
				var _pick3 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee3(params, context) {
...
function findPort(socket, editor) {
	...
	return (socket.side === "input" ? node.inputs : node.outputs)[socket.key];
}
...
function syncConnections(sockets, editor) {
	var connections = sockets.map(function(socket) {
		...
		if (port === null || port === void 0 ? void 0 : port.multipleConnections) return [];
		return findConnections(socket, editor);
	}).flat();
	return { commit: function commit() {
		Array.from(new Set(connections.map(function(_ref) {
			return _ref.id;
		}))).forEach(function(id) {
	...
	return _createClass(PickedExisting, [
		{
			key: "init",
			value: function() {
				var _init = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee2(context) {
					var _this3 = this;
					return import_regenerator.default.wrap(function _callee2$(_context2) {
						while (1) switch (_context2.prev = _context2.next) {
							case 0: context.scope.emit({
								type: "connectionpick",
								data: { socket: this.outputSocket }
		...
		},
		{
			key: "pick",
			value: function() {
				var _pick2 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee3(_ref2, context) {
...
var Idle = /* @__PURE__ */ function(_State3) {
	...
	return _createClass(Idle, [{
		key: "pick",
		value: function() {
			var _pick3 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee4(_ref3, context) {
	...
	return _createClass(ClassicFlow, [
		{
			key: "pick",
			value: function() {
				var _pick4 = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee5(params, context) {
...
var ConnectionPlugin = /* @__PURE__ */ function(_Scope) {
	function ConnectionPlugin() {
		...
		_defineProperty(_this, "preudoconnection", createPseudoconnection({ isPseudo: true }));
	...
	*/
	...
	return _createClass(ConnectionPlugin, [
		...
		},
		{
			key: "pick",
			value: function() {
				var _pick = _asyncToGenerator(/* @__PURE__ */ import_regenerator.default.mark(function _callee(event, type) {
					...
					return import_regenerator.default.wrap(function _callee$(_context) {
						while (1) switch (_context.prev = _context.next) {
							...
							case 10: this.preudoconnection.mount(this.areaPlugin);
							case 11:
								_context.next = 14;
								break;
							case 13: if (this.currentFlow) this.currentFlow.drop(flowContext);
							case 14:
