...
export class SetAngularVelocityNode extends ClassicPreset.Node {
  constructor() {
    super('Set Angular Velocity');
...
registerNode('Set Angular Velocity', 'Physics', () => new SetAngularVelocityNode());
