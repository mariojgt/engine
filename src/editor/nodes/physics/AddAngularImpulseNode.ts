...
export class AddAngularImpulseNode extends ClassicPreset.Node {
  constructor() {
    super('Add Angular Impulse');
...
registerNode('Add Angular Impulse', 'Physics', () => new AddAngularImpulseNode());
