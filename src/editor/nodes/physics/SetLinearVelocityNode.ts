...
export class SetLinearVelocityNode extends ClassicPreset.Node {
  constructor() {
    super('Set Linear Velocity');
...
registerNode('Set Linear Velocity', 'Physics', () => new SetLinearVelocityNode());
