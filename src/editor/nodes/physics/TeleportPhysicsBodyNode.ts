...
export class TeleportPhysicsBodyNode extends ClassicPreset.Node {
  constructor() {
    super('Teleport Physics Body');
...
registerNode('Teleport Physics Body', 'Physics', () => new TeleportPhysicsBodyNode());
